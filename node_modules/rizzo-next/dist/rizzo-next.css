...
.sub-navigation {
  ...
  transition: opacity 400ms, box-shadow 1200ms, -webkit-transform 400ms;
  transition: opacity 400ms, transform 400ms, box-shadow 1200ms;
  transition: opacity 400ms, transform 400ms, box-shadow 1200ms, -webkit-transform 400ms;
  width: 29rem;
  z-index: 101;
}
...
.mobile-navigation__list {
  transition: opacity 400ms 100ms, -webkit-transform 400ms 100ms;
  transition: transform 400ms 100ms, opacity 400ms 100ms;
  transition: transform 400ms 100ms, opacity 400ms 100ms, -webkit-transform 400ms 100ms;
}
