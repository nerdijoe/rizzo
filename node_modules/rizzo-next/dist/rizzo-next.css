...
.search {
  ...
  opacity: 0;
  transition: opacity 400ms, box-shadow 800ms;
}
...
@media (min-width: 45em) {
  ...
  .search--visible {
    box-shadow: 0.5rem 0 23rem rgba(0, 0, 0, 0.5);
  }
}
...
.search__container--slim {
  max-width: 107rem;
}

.search__container--narrow {
  max-width: 96rem;
}

.search__container--half {
  max-width: 63rem;
}
...
.search__close:hover, .search__close:active, .search__close:focus {
  color: #287bbb;
}
...
.search-results__more::after, .search-results__more::before {
  transition-duration: 300ms;
  transition-property: color, border, background;
}
...
.search-results__more:hover::after, .search-results__more:hover::before {
  transition-duration: 0;
}
...
.search-results__more [class*="icon-"] {
...
.search-results__more:hover [class*="icon-"] {
...
@media (min-width: 45em) {
  .search-item:hover .search-item__name, .search-item:active .search-item__name, .search-item:focus .search-item__name {
...
.search-item__name .is-highlight {
  color: #333;
}

.search-item--selected .search-item__name {
  -webkit-transform: translateX(0.75rem);
      -ms-transform: translateX(0.75rem);
          transform: translateX(0.75rem);
}
...
.notification-badge--user, .notification-badge--user-inline {
  position: absolute;
  top: 0;
  right: -.2rem;
  width: 1.5rem;
...
@media (min-width: 45em) and (max-width: 67.4375em) {
  .navigation__item:first-child {
    display: inline-block;
  }
}
...
.navigation--narrow .navigation__item--user > a {
  border: 0.1rem solid #bebebe;
  border-radius: 2.2rem;
  padding: 1.7rem 2rem;
}

.navigation--narrow .navigation__item--user > a:hover {
  border-color: #287bbb;
}

.navigation--narrow .navigation__item--user > a.avatar {
  padding: 0;
  border: none;
}
...
.navigation--narrow .navigation__link:hover {
  color: #287bbb;
}
...
.mobile-navigation__list {
  ...
  transition: -webkit-transform 400ms 100ms, opacity 400ms 100ms;
...
.header--no-images.header--narrow .header__inner {
...
.header__search:hover [class*="icon-"] {
...
.header__search-beyond,
.header__search:hover .header__search-text {
  opacity: .4;
}

.header--narrow .header__search {
  color: #333;
}
...
.header__mobile-search, .header__mobile-menu, .header__mobile-cart {
  position: relative;
  display: block;
  color: #fff;
  text-indent: -9999rem;
...
.header__mobile-search:before, .header__mobile-menu:before, .header__mobile-cart:before {
  display: block;
  position: absolute;
  top: 0;
  left: 0;
...
.header__mobile-menu .menu-icon, .header__mobile-menu .menu-icon:before, .header__mobile-menu .menu-icon:after {
  display: block;
  position: absolute;
  height: .2rem;
  background-color: #fff;
...
.header__mobile-menu .menu-icon:before, .header__mobile-menu .menu-icon:after {
  content: "";
  left: 0;
  right: 0;
}
...
.header--narrow .header__mobile-menu .menu-icon, .header--narrow .header__mobile-menu .menu-icon:before, .header--narrow .header__mobile-menu .menu-icon:after {
