      ...
      <div class="header__navigation">
        <nav class="navigation navigation--narrow navigation--no-images">
          <ul class="navigation__list">
              <li class="js-nav-item navigation__item js-search" data-lpa-category="Destinations Next" data-lpa-action="Global Navigation Click" data-lpa-label="Search">
          ...
          <nav class="mobile-navigation">
            ...
            <ul class="mobile-navigation__list">
                <li class="js-nav-item mobile-navigation__item mobile-js-search" data-lpa-category="Destinations Next" data-lpa-action="Mobile Global Navigation Click" data-lpa-label="Search">
